...
以下のユーザーの **traits（自己定義した生活文脈）** とカレンダー情報を分析し、2つの出力を生成してください:
1. **提案** — カレンダーに追加すべきイベントの提案
2. **観察** — カレンダーやtraitsから読み取れる行動パターン・傾向の記録
...
- 空き時間を有効活用する提案をする
- 過去にした提案と重複しないこと
- カレンダーの傾向から行動パターンを読み取り、観察として記録する
